...
from cudf.api.types import is_categorical_dtype, is_numeric_dtype, is_string_dtype
...
def _check_types(left, right, check_categorical=True, exact="equiv", obj="Index"):
    ...
    if exact and not isinstance(left, cudf.MultiIndex) and is_categorical_dtype(left):
